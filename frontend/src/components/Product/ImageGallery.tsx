  ...
  return (
    <div data-testid="product-gallery">
      <div className="flex gap-4">
        {/* Thumbnail Column with repositioned up and down arrows */}
        <div className="w-1/5 flex flex-col items-center relative">
          {thumbStart > 0 && (
            <button 
              onClick={handleThumbUp} 
              aria-label="Scroll up" 
              className="absolute -top-10 left-1/2 transform -translate-x-1/2 p-2 bg-white shadow border rounded-full"
            >
              ↑
            </button>
          )}
          ...
          {thumbStart + thumbnailsToShow < filteredGallery.length && (
            <button 
              ...
              className="absolute -bottom-10 left-1/2 transform -translate-x-1/2 p-2 bg-white shadow border rounded-full"
            >
              ↓
            </button>
          )}
        ...
        {/* Main Image with centered Navigation arrows */}
        <div 
          ref={mainImageRef}
        ...
        >
          ...
          {filteredGallery.length > 1 && (
            <>
              <button
                className="absolute left-2 top-1/2 transform -translate-y-1/2 p-2 bg-white shadow border rounded-full"
              ...
              <button
                className="absolute right-2 top-1/2 transform -translate-y-1/2 p-2 bg-white shadow border rounded-full"
